...
(function () {
  ...
  var JP_TRIVIA = [
    ...
    "輪ゴムは、暖かい場所に置いておく方が長持ちすると言われています。",
    "「モナ・リザ」には眉毛が描かれていません。",
    "アリには肺がなく、体の表面全体で呼吸をしています。",
    "猫は液体のように、どんな隙間にも入り込もうとする習性があります。",
    "エレベーターの「閉」ボタンは、実は作動していない機種もあると言われています。",
    "自動販売機のボタンを連打しても、商品が出てくる速さは変わりません。",
    "あくびは、他人がしているのを見るとうつりやすいと言われています。",
    "「サンドイッチ」という名前は、トランプをしながら食事を続けたかった貴族に由来するという説があります。",
    "「ハンバーガー」という名前は、ドイツのハンブルクに由来すると言われています。",
    "ポテトチップスは、料理への苦情への腹いせで薄く切られたのが始まりという説があります。",
    "コアラの指紋は、人間のものとほとんど見分けがつかないほどよく似ています。",
    "切手の裏側の「のり」は、なめてもほとんど味がしないように作られています。",
    "「じゃんけん」に似た遊びは、世界のさまざまな国に存在します。",
    "冷蔵庫の扉を閉めると、中の電気はちゃんと消えます(当たり前ですが)。",
    "「ぬいぐるみ」という言い方は、英語の直訳ではなく日本語独自の表現です。",
    "カップ焼きそばの「お湯を捨てる穴」は、位置が絶妙にずれていると感じる人が多いようです。",
    "ラーメン屋の「マシマシ」は、注文時の掛け声として広まった言葉です。",
    "「バナナはおやつに含まれますか」という質問は、遠足のしおりの定番ネタです。",
    "カラオケの採点機能は、同じ歌でも機種によって点数が変わることがあります。",
    "エスカレーターで片側を空ける習慣は、地域によって左右が逆になります。"
  ];
